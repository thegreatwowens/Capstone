...
namespace QInventory
{
    public class Tooltip : MonoBehaviour
    {
        ...
        public void ConstructDataString(string tag, ItemData itemdata)
        {
            ...
            go.GetComponent<TextMeshProUGUI>().text = "<color=#00f0ff><b>" + item.itemName + "</b></color>";
            go.GetComponent<TextMeshProUGUI>().alignment = TextAlignmentOptions.Midline;
            //描述
            go = Instantiate(toolTipText, gridList.transform);
            go.GetComponent<TextMeshProUGUI>().text = "Description:";

            go = Instantiate(toolTipText, gridList.transform);
            go.GetComponent<TextMeshProUGUI>().text = item.description;
        ...
        void AddSellPriceInformation()
        {
            ...
            //data += "Sell Price:\n";
            go = Instantiate(toolTipText, gridList.transform);
            go.GetComponent<TextMeshProUGUI>().text = "Sell Price:";

            foreach (var price in item.sell_Price)
            {
                go = Instantiate(toolTipText, gridList.transform);
                go.GetComponent<TextMeshProUGUI>().text = price.amount + "  " + price.currency.currencyName;
        ...
        void AddConsumableInfomation()
        {
            ...
            go = Instantiate(toolTipText, gridList.transform);
            go.GetComponent<TextMeshProUGUI>().text = "<color=#ff0000><b> ConsumableAttributes: </b></color>";
            ...
            foreach (ConsumableAttribute m_Attribute in item.consumableItemAttributes)
            {
                ...
                go = Instantiate(toolTipText, gridList.transform);
                go.GetComponent<TextMeshProUGUI>().text = "<color=#c0d54f>" + m_Attribute.consumableItemAttribute.attributeName + "</color>  " + m_Attribute.effectType + "  " + m_Attribute.value;
            }
        }
        ...
        void AddEquipmentInfomation()
        {
            ...
            go = Instantiate(toolTipText, gridList.transform);
            go.GetComponent<TextMeshProUGUI>().text = "<color=#ff0000><b>EquipmentAttributes: </b></color>";
            foreach (EquipmentAttribute m_Attribute in item.equipmentItemAttributes)
            {
                ...
                go = Instantiate(toolTipText, gridList.transform);
                go.GetComponent<TextMeshProUGUI>().text = "<color=#c0d54f>" + m_Attribute.equipmentItemAttribute.attributeName + "</color>  " + m_Attribute.effectType + "  " + m_Attribute.value;
            }
        }
        ...
        void AddCraftingInfomation(ItemData itemdata)
        {
            ...
            go = Instantiate(toolTipText, gridList.transform);
            go.GetComponent<TextMeshProUGUI>().text = "<color=#ff0000><b>Crafting Ingredients</b></color>";
            foreach (Ingredient m_Ingredient in itemdata.m_CraftingBluePrint.ingredients)
            {
                ...
                go = Instantiate(toolTipText, gridList.transform);
                go.GetComponent<TextMeshProUGUI>().text = m_Ingredient.ingredient.name + "  " + m_Ingredient.amount;
            }
        }
