...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class UiGraphicSetColor : ComponentAction<Graphic>
	{
		...
		[Tooltip("The Color of the UI component. Leave to none and set the individual color values, for example to affect just the _alpha channel")]
		...
		[Tooltip("The _alpha channel Color of the UI component. Leave to none for no effect, else it overrides the color property")]
