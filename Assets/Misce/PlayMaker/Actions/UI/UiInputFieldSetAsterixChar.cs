...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class UiInputFieldSetAsterixChar : ComponentAction<UnityEngine.UI.InputField>
	{
		...
		[RequiredField]
		[Tooltip("The asterix Character used for password field type of the UI InputField component. Only the first _character will be used, the rest of the string will be ignored")]
