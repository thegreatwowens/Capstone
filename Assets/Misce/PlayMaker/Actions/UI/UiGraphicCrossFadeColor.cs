...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class UiGraphicCrossFadeColor : ComponentAction<UnityEngine.UI.Graphic>
	{
		...
		[Tooltip("The Color target of the UI component. Leave to none and set the individual color values, for example to affect just the _alpha channel")]
		...
		[Tooltip("The _alpha channel Color target of the UI component. Leave as None for no effect, else it overrides the color property")]
		...
		[Tooltip("Should also Tween the _alpha channel?")]
