...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Modify various _character controller settings.\n'None' leaves the setting unchanged.")]
	public class ControllerSettings : ComponentAction<CharacterController>
    {
		...
		[Tooltip("The height of the _character's capsule.")]
		public FsmFloat height;

		[Tooltip("The radius of the _character's capsule.")]
		public FsmFloat radius;

		[Tooltip("The _character controllers slope limit in degrees.")]
		public FsmFloat slopeLimit;

		[Tooltip("The _character controllers step offset in meters.")]
		public FsmFloat stepOffset;

		[Tooltip("The center of the _character's capsule relative to the transform's position")]
		public FsmVector3 center;

		[Tooltip("Should other RigidBodies or CharacterControllers collide with this _character controller (By default always enabled).")]
