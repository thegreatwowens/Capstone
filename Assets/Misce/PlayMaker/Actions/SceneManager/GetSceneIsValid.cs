...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Get a scene isValid flag. A scene may be invalid if, for example, you tried to doorOpen a scene that does not exist. In this case, the scene returned from EditorSceneManager.OpenScene would return False for IsValid. ")]
