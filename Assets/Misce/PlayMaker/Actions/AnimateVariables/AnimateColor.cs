...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class AnimateColor : AnimateFsmAction
	{
        ...
        [RequiredField]
        [Tooltip("The curve used to animate the _alpha value.")]
		public FsmAnimationCurve curveA;
		
        [Tooltip("Calculation lets you set a type of curve deformation that will be applied to the _alpha channel.")]
