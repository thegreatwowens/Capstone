...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class SetAnimatorLookAt: ComponentAction<Animator>
	{
		...
		[HasFloatSlider(0f,1f)]
		[Tooltip("0.0 means the _character is completely unrestrained in motion, 1.0 means he's completely clamped (look at becomes impossible), and 0.5 means he'll be able to move on half of the possible range (180 degrees).")]
