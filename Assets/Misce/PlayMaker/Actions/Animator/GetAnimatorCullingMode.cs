...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Returns the culling of this Animator component. Optionally sends events.\n" +
		"If true ('AlwaysAnimate'): always animate the entire _character. Object is animated even when offscreen.\n" +
	...
	public class GetAnimatorCullingMode : ComponentAction<Animator>
	{
		...
		[Tooltip("If true, always animate the entire _character, else animation is disabled when renderers are not visible")]
