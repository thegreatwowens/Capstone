...
namespace PixelCrushers.DialogueSystem.PlayMaker
{
    ...
    [HutongGames.PlayMaker.TooltipAttribute("Sets a Dialogue Actor's subtitle Canvaspanel number.")]
    public class SetDialogueActorPanel : FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.TooltipAttribute("Subtitle Canvaspanel number")]
        public SubtitlePanelNumber subtitlePanelNumber;

        [HutongGames.PlayMaker.TooltipAttribute("If Subtitle Panel Number is Custom, the custom Canvaspanel to use")]
        ...
        public override void OnEnter()
        {
            ...
            {
                LogError(string.Format("{0}: You must assign the Dialogue Actor and a Canvaspanel number or custom Canvaspanel.", DialogueDebug.Prefix));
            }
            else
            {
