...
namespace PixelCrushers
{
    ...
    public class PlayMakerGlobalVariableSaver : Saver
    {
        ...
        public class Data
        {
            ...
            public List<ObjectArray> arrayValues = new List<ObjectArray>();
        }
        ...
        public override string RecordData()
        {
            ...
            foreach (var arrayVar in FsmVariables.GlobalVariables.ArrayVariables)
            {
                data.arrayNames.Add(arrayVar.Name);
                data.arrayValues.Add(new ObjectArray(arrayVar.Values));
            }
        ...
        public override void ApplyData(string s)
        {
            ...
            for (int i = 0; i < data.arrayNames.Count; i++)
            {
                var arrayVar = FsmVariables.GlobalVariables.FindFsmArray(data.arrayNames[i]);
                if (arrayVar != null) arrayVar.Values = data.arrayValues[i].array;
            }
        }
