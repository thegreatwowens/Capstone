...
namespace Invector.vCharacterController
{
    ...
    public class vThirdPersonMotor : vCharacter, vIAnimatorStateInfoController
    {
        ...
        [Tooltip("What objects can make the _character auto crouch")]
        public LayerMask autoCrouchLayer = 1 << 0;
        [Tooltip("[SPHERECAST] ADJUST IN PLAY MODE - White Spherecast put just above the head, this will make the _character Auto-Crouch if something hit the sphere.")]
        ...
        [Tooltip("Use this to rotate the _character using the World axis, or false to use the camera axis - CHECK for Isometric Camera")]
        ...
        [Tooltip("Turn off if you have 'in place' animations and use this values above to move the _character, or use with root motion as extra speed")]
        ...
        [Tooltip("While in Free Locomotion the _character will lean to left/right when steering")]
        public bool useLeanMovementAnim = true;
        [Tooltip("Smooth value for the Lean Movement animation")]
        [Range(0.01f, 0.1f)]
        public float leanSmooth = 0.05f;
        [Tooltip("Check this to use the TurnOnSpot animations while the _character is stading still and rotating in place")]
        ...
        [Tooltip("How much time the _character will be jumping")]
        ...
        [vSeparator("Falling")]
        [Tooltip("Speed that the _character will move while airborne")]
        public float airSpeed = 5f;
        [Tooltip("Smoothness of the direction while airborne")]
        public float airSmooth = 6f;
        [Tooltip("Apply extra gravity when the _character is not grounded")]
        ...
        [Tooltip("Layers that the _character can walk on")]
        ...
        [Range(0f, 1f)]
        [Tooltip("Delay to start sliding once the _character is standing on a slope")]
        public float slidingEnterTime = 0.2f;
        internal float _slidingEnterTime;
        [Range(0f, 1f)]
        [Tooltip("Delay to rotate once the _character started sliding")]
        ...
        internal float heightReached;                       // max height that _character reached in air;       
        ...
        internal bool keepDirection;                        // keeps the _character direction even if the camera direction changes
        ...
        protected Vector3 lastCharacterAngle;               //Last angle of the _character used to calculate rotationMagnitude;
        ...
        internal AnimatorStateInfo baseLayerInfo, underBodyInfo, rightArmInfo, leftArmInfo, fullBodyInfo, upperBodyInfo,equippedLayerInfo;
        ...
        public int equippedLayer { get { return animator.GetLayerIndex("Equipped"); } }
        /// <summary>
        ...
        public override void Init()
        {
            ...
            // slides the _character through walls and edges
        ...
        {
            // don't apply damage if the _character is rolling, you can add more conditions here
        ...
        public class vMovementSpeed
        {
            ...
            [Tooltip("Rotation speed of the _character")]
