...
namespace Invector.vCharacterController.vActions
{
    ...
    public class vTriggerLadderAction : vMonoBehaviour
    {
        ...
        [Tooltip("Use this to limit the trigger to active if forward of _character is close to this forward")]
        public bool activeFromForward;      
        [Tooltip("Rotate Character for this rotation when active")]
        public bool useTriggerRotation;


        [Tooltip("Target Character parent, used to movable ladders to set _character child of target, keep empty if ladder is static")]
        public Transform targetCharacterParent;
        [vEditorToolbar("MatchTarget")]
        [Tooltip("Use a transform to help the _character climb any height, take a look at the Example Scene ClimbUp, StepUp, JumpOver objects.")]
        public Transform matchTarget;
        [Tooltip("Use a empty gameObject as a reference for the _character to exit")]
