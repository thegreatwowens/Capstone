...
namespace Invector.vCharacterController.vActions
{
    ...
    public class vTriggerGenericAction : vMonoBehaviour
    {
        ...
        [vHelpBox("It will only use the trigger if the forward of the _character is close to the forward of this transform")]
        public bool activeFromForward;
        [vHelpBox("Max angle between _character forward and trigger forward to active trigger"), Range(5, 180)]
        ...
        [Tooltip("You can use this to make a persistent action, and finish the action calling FinishAction method of the vGenericAction  component in your _character")]
