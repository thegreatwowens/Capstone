...
namespace Invector.vCharacterController
{
    ...
    public class vThirdPersonInput : vMonoBehaviour, vIAnimatorMoveReceiver
    {
        ...
        /// <summary>
        /// If you're using the MoveCharacter method with a custom targetDirection, check this true to align the _character with your custom targetDirection
        /// </summary>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Limits the _character to walk only, useful for cutscenes and 'indoor' areas
        /// </summary>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Set the _character to Strafe Locomotion
        /// </summary>
        /// <param name="value"></param>
        ...
        public virtual void ControlRotation()
        {
            ...
            {
                cc.RotateToPosition(tpCamera.lockTarget.position);          // rotate the _character to a specific target
            }
            else
            {
