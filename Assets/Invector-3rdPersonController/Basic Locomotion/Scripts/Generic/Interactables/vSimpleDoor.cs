...
namespace Invector
{
    ...
    public class vSimpleDoor : vMonoBehaviour
    {
        ...
        [vHideInInspector("autoOpen"), Tooltip("Min angle between _character forward and door that  can auto doorOpen")]
        public float minAngleToOpen = 45f;
        [Tooltip("Door can doorOpen to left side and to right side, if false, door will doorOpen just in to right side")]
        ...
        /// <summary>
        /// Set Door to auto doorOpen
        /// </summary>
        /// <param name="value"> auto doorOpen </param>
        ...
        /// Open Door
        /// </summary>
        /// <param name="invert">invert direction to doorOpen</param>
